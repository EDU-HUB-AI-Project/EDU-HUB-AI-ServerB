    ...
    <div class="contents-wrap">
        ...
        <div class="subpage-body" id="transport-content">
            ...
            <div id="route-buttons">
                <button type="button" class="route-btn active" data-route="station" onclick="searchRoute('station', this)">울산역</button>
                ...
                <button type="button" class="route-btn" data-route="shuttle" onclick="searchRoute('shuttle', this)">셔틀버스</button>
            </div>

            <div id="map-transport" aria-label="교통 안내 지도"></div>

            <div id="transport-info">
                <div class="route-card route-card-station active" data-type="station">
