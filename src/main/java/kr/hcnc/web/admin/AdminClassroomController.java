...
public class AdminClassroomController {
	...
	@GetMapping
	public ResponseEntity<List<ClassroomVO>> getClassroom() {
		log.info("Called :: GET /admin/classroom");
		return ResponseEntity.ok(adminClassroomService.selectClassroom());
	}
	
	@GetMapping("/{classroomId}")
	public ResponseEntity<ClassroomVO> getClassroomById(@PathVariable String classroomId) {
	...
	public ResponseEntity<?> insertClassroom(@RequestBody ClassroomVO classroomVO) {
		...
		Map<String, Object> response = adminClassroomService.insertClassroom(classroomVO);
	...
	public ResponseEntity<?> updateClassroom(@PathVariable String classroomId, @RequestBody ClassroomVO classroomVO) {
		...
		Map<String, Object> response = adminClassroomService.updateClassroom(classroomId, classroomVO);
